                ...
                for (int j = 0; j <= cMax; j++)
                {
                    if (data[i, j] == 0)
                    {
                        ...
                        if (i - 1 < 0 || data[i-1, j] >= 1)
                        {
                            ...
                            {
                                Instantiate(Prefabs[12], new Vector3(j * width + ypos, halfH - 0.5f, (i - .5f) * width + ypos), Quaternion.Euler(new Vector3(0, 0, 0)));
                            }
                        }
                        ...
                        if (j + 1 > cMax || data[i, j+1] >= 1)
                        {
                            ...
                            {
                                Instantiate(Prefabs[12], new Vector3((j + .5f) * width + ypos, halfH - 0.5f, i * width + ypos), Quaternion.Euler(new Vector3(0, 270, 0)));
                            }
                        }
                        ...
                        if (j - 1 < 0 || data[i, j-1] >= 1)
                        {
                            ...
                            {
                                Instantiate(Prefabs[12], new Vector3((j - .5f) * width + ypos, halfH - 0.5f, i * width + ypos), Quaternion.Euler(new Vector3(0, 90, 0)));
                            }
                        }
                        ...
                        if (i + 1 > rMax || data[i+1, j] >= 1)
                        {
                            ...
                            {
                                Instantiate(Prefabs[12], new Vector3(j * width + ypos, halfH - 0.5f, (i + .5f) * width + ypos), Quaternion.Euler(new Vector3(0, 180, 0)));
                            }
                        }
                    }
                }
